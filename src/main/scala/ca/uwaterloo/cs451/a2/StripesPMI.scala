...
object StripesPMI extends Tokenizer {
  ...
  class PartitionerStripesPMI(partitions: Int) extends Partitioner {
  ...
  def main(argv: Array[String]) {
    ...
    val counts = textFile
      ...
      .filter(p => (p._1._2 != "*"))
      .map(p => (p._1._1, (p._1._2 + "=(" + p._2._1.toString + ", " + p._2._2.toString + ")")))
      .groupByKey()

      .repartitionAndSortWithinPartitions(new PartitionerStripesPMI(args.reducers()))
